...
/* custom.js */
$(document).ready(function(){function a(){return $(".nav").onePageNav({filter:":not(.external)",scrollSpeed:1500}),$(".js-scroll").on("click",function(){var a=$($(this).attr("href"));return $("html, body").animate({scrollTop:a.offset().top},1500),!1}),!1}function b(){$("aside").backstretch(["img/placeholder-1.jpg","img/placeholder-2.jpg","img/placeholder-3.jpg","img/placeholder-4.jpg"],{duration:5e3,fade:1e3})}function c(){$(".flexslider").flexslider({animation:"slide",slideshow:!1,touch:!0})}a(),b(),c(),$(".top-bar-section a").click(function(){$(".top-bar").removeClass("expanded")})});